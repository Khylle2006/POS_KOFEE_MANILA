...
<body>
    ...
    function addMenuItem() {
        ...
        if (!cat || !name || isNaN(priceSmall) || priceSmall <= 0 || isNaN(priceLarge) || priceLarge <= 0) {
            msg.style.display    = 'block';
            msg.style.background = '#ffebee';
            msg.style.color      = '#c62828';
            msg.textContent      = '⚠️ Please fill all required fields correctly.';
            return;
        }
        ...
        form.append('price_small',  priceSmall);
        form.append('price_large',  priceLarge);
